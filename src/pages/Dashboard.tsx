    ...
    >
      ...
      <div className="px-4 flex flex-col gap-4 mt-0 w-full">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div ref={dragScrollRef} className="flex overflow-x-auto gap-4 pb-2 -mx-4 px-4 scrollbar-none select-none">
            <div 
              onClick={() => navigate('/premium')}
              className="w-[85%] sm:w-[380px] rounded-[18px] overflow-hidden relative flex flex-col h-[240px] flex-shrink-0 active:scale-[0.98] transition-all cursor-pointer shadow-xl"
            >
              <div className="h-[60%] relative w-full">
                <img src="https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?w=500&auto=format&fit=crop&q=60" alt="Treino" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/20" />
              </div>
              <div className="h-[40%] bg-[#1a4fba] p-3.5 w-full flex flex-col justify-center items-center">
            ...
            >
              <div className="h-[60%] relative w-full">
                <img src="https://images.unsplash.com/photo-1579722820308-d74e571900a9?w=500&auto=format&fit=crop&q=60" alt="Whey" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/20" />
              </div>
              <div className="h-[40%] bg-[#1a4fba] p-3.5 w-full flex flex-col justify-center items-center">
            ...
            >
              <div className="h-[60%] relative w-full">
                <img src="https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500&auto=format&fit=crop&q=60" alt="Camiseta fitClub" className="w-full h-full object-cover object-top" />
                <div className="absolute inset-0 bg-black/20" />
              </div>
              <div className="h-[40%] bg-[#1a4fba] p-3.5 w-full flex flex-col justify-center items-center">
