    ...
    >
      ...
      <div className="px-4 flex flex-col gap-4 mt-0 w-full">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div ref={dragScrollRef} className="flex overflow-x-auto gap-4 pb-2 -mx-4 px-4 snap-x scrollbar-none">
            <div 
              onClick={() => navigate('/premium')}
              className="min-w-[290px] w-[88%] sm:w-[320px] rounded-[18px] overflow-hidden snap-center relative flex flex-col h-[240px] active:scale-[0.98] transition-all cursor-pointer shadow-xl"
            >
